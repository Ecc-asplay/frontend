import GuidelinesSetting from "../guidelines_setting/page";
...
const SideBarSelected: (onselect: (key: string) => void) => Record<string, JSX.Element> = (onselect) => ({
    ...
    about: (
        <div className="flex flex-col px-6 py-12 h-screen overflow-y-auto hidden-scrollbar">
            ...
            <div className="text-basetext leading-relaxed max-w-screen-md ml-3">
                <p className="mt-4 my-4 leading-8 mx-5">
                    このサイトは、患者さんやそのサポーターの方々が安全で温かく、匿名で体験を共有できる場を提供することを目的としています。
                    日記や経験を共有することで、不安を和らげ、力を分かち合い、すべてのユーザーが理解とサポートを感じられる場所を目指しています。
                </p>

                <h2 className="text-basetext font-bold text-lg">■ 主要機能</h2>
                <ul className="list-disc list-inside pl-4 my-5 space-y-4">
                    <li className="mb-2">
                        <strong>匿名投稿：</strong>
                ...
                <h2 className="text-basetext font-bold text-lg">■ ご利用上の注意</h2>
                <ul className="list-disc list-inside pl-4 my-5 space-y-4">
                    <li className="mb-2">
                ...
                <h2 className="text-basetext font-bold text-lg">■ 私たちのビジョン</h2>
                <p className="my-2 leading-8 mx-5">
                    個人の体験を共有することで、お互いに励まし合い、ストレスを軽減する場を目指します。
                    すべてのユーザーが、このコミュニティを通じて温かさや共感、そして力を見つけられるように、一緒に素晴らしい空間を作り上げましょう。
                </p>
                <p className="mt-4 font-bold text-baseyellow mb-10">
    ...
    terms: (
        <div className="flex flex-col px-6 py-12 h-screen overflow-y-auto hidden-scrollbar">
            ...
            <div className="text-basetext leading-relaxed max-w-screen-md ml-3">
                ...
                <h2 className="font-bold text-lg mt-6">第5条（コメントの取り扱い）</h2>
                <p className="my-2 leading-8 mx-5">
                ...
                <h2 className="font-bold text-lg mt-6">第6条（投稿内容の削除）</h2>
                <p className="my-2 leading-8 mx-5">
                ...
                <h2 className="font-bold text-lg mt-6">第7条（免責事項）</h2>
                <p className="my-2 leading-8 mx-5">
                ...
                <h2 className="font-bold text-lg mt-6">第8条（サービスの変更・終了）</h2>
                <p className="my-2 leading-8 mx-5">
                    運営は、事前の通知なく本サービスの内容を変更または終了することができるものとします。
                </p>

                <h2 className="font-bold text-lg mt-6">第9条（規約の変更）</h2>
                <p className="my-2 leading-8 mx-5">
                    運営は、必要に応じて本規約を変更することができます。変更後の規約は、本サイト上に掲示された時点から効力を有するものとします。
                </p>

                <h2 className="font-bold text-lg mt-6">第10条（準拠法および管轄）</h2>
                <p className="my-2 leading-8 mx-5 mb-10">
    ...
    privacy: (
        <div className="flex flex-col px-6 py-12 h-screen overflow-y-auto hidden-scrollbar">
            ...
            {/* 本文 */}
            <div className="text-basetext leading-relaxed max-w-screen-md ml-3">
                <h2 className="font-bold text-lg mt-6">第1条（基本方針）</h2>
                <p className="my-2 leading-8 mx-5">
                ...
                <h2 className="font-bold text-lg mt-6">第2条（適用範囲）</h2>
                <p className="my-2 leading-8 mx-5">
                    本ポリシーは、本サイトを利用するすべてのユーザーに適用されます。また、ユーザーが本サイトを利用することで、本ポリシーに同意したものとみなします。
                </p>

                <h2 className="font-bold text-lg mt-6">第3条（収集する情報）</h2>
                <p className="my-2 leading-8 mx-5">
                ...
                <h2 className="font-bold text-lg mt-6">第4条（情報の利用目的）</h2>
                <p className="my-2 leading-8 mx-5">
                ...
                <h2 className="font-bold text-lg mt-6">第5条（個人情報の管理）</h2>
                <p className="my-2 leading-8 mx-5">
                ...
                <h2 className="font-bold text-lg mt-6">第6条（第三者への提供）</h2>
                <p className="my-2 leading-8 mx-5">
                ...
                <h2 className="font-bold text-lg mt-6">第9条（プライバシーポリシーの変更）</h2>
                <p className="my-2 leading-8 mx-5 mb-10">
