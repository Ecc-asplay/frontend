...
import waring from "@/app/img/admin/warning.svg";
import user from "@/app/img/admin/user.svg";
import logout from "@/app/img/admin/log-out.png";
import gear from "@/app/img/admin/gear.svg";
import phone from "@/app/img/admin/phone.svg";
import comment from "@/app/img/admin/comment.svg";
...
export default function Admin(){
    const handleClick = (e:React.MouseEvent<HTMLButtonElement, MouseEvent>)=>{
        ...
        navs.forEach(e=>e.classList.remove("text-[#000000]"));
        target.classList.add("bg-[#CAD9BA]");
        target.classList.add("text-[#000000]");
        setSelect(target.id);
    }
    ...
    return(
        <div className="w-full h-screen relative">
            ...
            <div className="flex object-cover w-full h-full">
                {/* 左側 */}
                <div className="object-cover w-[17%] h-full flex flex-col items-center bg-[#A5BCA2] text-white text-left text-xl font-bold">
                    <button onClick={(e)=>handleClick(e)} className="nav flex justify-between items-center object-cover w-full ml-3 p-5 bg-[#CAD9BA] text-[#000000]" id="adminUsers"><p>ユーザー管理</p><Image src={user} alt="icon" width={30} height={30}/></button>
