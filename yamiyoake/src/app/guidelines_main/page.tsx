...
import left from "@/app/img/left-svgrepo-com.png";
    ...
    return (
        <>
            <div className="fixed top-0 w-full h-8 bg-headerbrown">
                <Link href={"/"}>
                    <button className="flex items-center text-white">
                        <Image src={left} width={35} height={35} alt="return" className="ml-3" />
                    </button>
                </Link>
            </div>
            <div className="flex flex-col overflow-auto hidden-scrollbar h-screen items-center bg-basebg px-6">
                ...
                {/* ガイドライン本文 */}
                <div className="mx-6 mt-6 mb-32 text-lg leading-relaxed max-w-screen-lg px-16 text-basetext">
