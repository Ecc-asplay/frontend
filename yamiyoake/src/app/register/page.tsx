                ...
                <form onSubmit={handleSubmit} className="p-5 rounded-lg w-full max-w-md space-y-4">
                    ...
                    <div className="flex space-x-3">
                        <label className="flex items-center space-x-2">
                            ...
                            <span 
                                ...
                                regiformData.gender === 'male' ? 'bg-basegreen' : 'bg-middlebrown'
                            }`}>
                        ...
                        <label className="flex items-center space-x-2">
                            ...
                            <span 
                                className={`w-5 h-5 rounded-full border-1 flex items-center justify-center ${
                                regiformData.gender === 'female' ? 'bg-basegreen' : 'bg-middlebrown'
                            }`}>
                                <span className="w-4 h-4 rounded-full flex items-center justify-center bg-basebg">
                        ...
                        <label className="flex items-center space-x-2">
                            ...
                            <span 
                                className={`w-5 h-5 rounded-full border-1 flex items-center justify-center ${
                                regiformData.gender === 'nocomment' ? 'bg-basegreen' : 'bg-middlebrown'
                            }`}>
                                <span className="w-4 h-4 rounded-full flex items-center justify-center bg-basebg">
                    ...
                    <div className="flex space-x-2">
                        <label className="flex items-center space-x-2">
                            ...
                            <span 
                                className={`w-5 h-5 rounded-full border-1 flex items-center justify-center ${
                                regiformData.isPublic === true ? 'bg-basegreen' : 'bg-middlebrown'
                            }`}>
                                <span className="w-4 h-4 rounded-full flex items-center justify-center bg-basebg">
                        ...
                        <label className="flex items-center space-x-2">
                            ...
                            <span 
                                className={`w-5 h-5 rounded-full border-1 flex items-center justify-center ${
                                regiformData.isPublic === false ? 'bg-basegreen' : 'bg-middlebrown'
                            }`}>
                                <span className="w-4 h-4 rounded-full flex items-center justify-center bg-basebg">
